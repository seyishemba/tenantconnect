<?php
		...
		$this->db->set('property_type', $main['property_type'])->set('title', $main['title'])->set('slug', $main['slug'])->set('location', $main['location'])->set('description', $main['description'])->set('amount', $main['amount'])->set('duration', $main['duration'])->set('when_to_move', $main['when_to_move'])->set('furnished', $main['furnished'])->set('size', $main['size'])->set('measurement', $main['measurement'])->set('bedrooms', $main['bedrooms'])->set('bathrooms', $main['bathrooms'])->where('id', $post_id)->update('listing');
