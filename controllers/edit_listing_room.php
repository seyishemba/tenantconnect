<?php
		...
		$this->db->set('property_type', $main['property_type'])->set('title', $main['title'])->set('slug', $main['slug'])->set('location', $main['location'])->set('description', $main['description'])->set('amount', $main['amount'])->set('duration', $main['duration'])->set('when_to_move', $main['when_to_move'])->set('furnished', $main['furnished'])->set('size', $main['size'])->set('measurement', $main['measurement'])->where('id', $post_id)->update('listing');
		...
		$this->db->set('min_age', $household['min_age'])->set('max_age', $household['max_age'])->set('household_number', $household['household_number'])->set('household_sex', $household['household_sex'])->where('listing_id', $post_id)->update('house_hold_listing');
		...
		$this->db->set('cleanliness', $lifestyle['cleanliness'])->set('overnight_guests', $lifestyle['overnight_guests'])->set('party_habits', $lifestyle['party_habits'])->set('get_up', $lifestyle['get_up'])->set('go_to_bed', $lifestyle['go_to_bed'])->set('food_preference', $lifestyle['food_preference'])->set('smoker', $lifestyle['smoker'])->set('work_schedule', $lifestyle['work_schedule'])->set('occupation', $lifestyle['occupation'])->where('listing_id', $post_id)->update('lifestyle_listing');
		...
		$this->db->set('min_age', $roommate['min_age'])->set('max_age', $roommate['max_age'])->set('smoke_preference', $roommate['smoke_preference'])->set('students_only', $roommate['students_only'])->where('listing_id', $post_id)->update('roommate_listing');
		...
		$this->db->set('cats', $pets['cats'])->set('dogs', $pets['dogs'])->set('smallpets', $pets['smallpets'])->set('birds', $pets['birds'])->set('fish', $pets['fish'])->set('reptiles', $pets['reptiles'])->where('listing_id', $post_id)->update('pets_listing');
		...
		$this->db->set('cats', $pets_preference['cats'])->set('dogs', $pets_preference['dogs'])->set('smallpets', $pets_preference['smallpets'])->set('birds', $pets_preference['birds'])->set('fish', $pets_preference['fish'])->set('reptiles', $pets_preference['reptiles'])->where('listing_id', $post_id)->update('pets_listing');

			$this->db->insert('prefered_pets_listing', $pets_preference);  
